...
var showPopoutFrameGame = function (content, width, height, left, top, closePopoutFrame, position, showMask, zIndex, showCloseBar, showScrollBar) {
    ...
    mainHtml += "<div " +
        ...
        + ";' >";
    if (showCloseBar == 1) {
        mainHtml += "<table class='class-table-100-percent-width' onclick='closePopoutSeller()'>";
        mainHtml += "<tr><td class='class-td-button-seller' style='border-radius:6px;' ></td>" +
            "<td class='class-td-button-seller' style='width:12px;height:12px;color:#666666; border-radius:6px;padding:6px;text-align:center;'>x</td>" +
            "</tr></table>";
    }

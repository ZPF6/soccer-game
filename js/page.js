...
var TEAM_COUNT_DEFAULT_VALUE = 26;
...
var PICTURE_COUNT_MAN = 1000;
var PICTURE_COUNT_WOMAN = 1000;
var PICTURE_COUNT_ACCOUNTANT = 169;
var PICTURE_COUNT_MANAGER = 600;
var PICTURE_COUNT_CAR = 191;
var PICTURE_COUNT_CUP = 23;
var PICTURE_COUNT_HOUSE = 193;
var PICTURE_COUNT_GIFT = 22;
var PICTURE_COUNT_MARRIAGE = 168;
var SEX_MAN = 0;
var SEX_WOMAN = 1;
...
var MEET_EVENT_ACTIONS = [
    {name: "电影院演员", percent: 20, actions: ["看电影"], costs: [100], words: ["帅哥，你是来看电影的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "火车站售票员", percent: 20, actions: ["买火车票"], costs: [100], words: ["帅哥，你是来买火车票的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "酒店前台服务员", percent: 20, actions: ["住店"], words: ["帅哥，要住店吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "酒吧吧台服务员", percent: 20, actions: ["喝一杯酒"], costs: [1000], words: ["帅哥，一个人喝酒啊，介意陪我一起喝吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "商场导购小姐", percent: 20, actions: ["购买商品"], costs: [1000], words: ["帅哥，要买这个商品吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "超市售货员", percent: 20, actions: ["买点吃的"], costs: [100], words: ["帅哥，要买这个食品吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "大饭店服务员", percent: 20, actions: ["点大餐"], costs: [1000], words: ["帅哥，你是来点大餐的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "小饭店服务员", percent: 20, actions: ["随意点份餐"], costs: [100], words: ["帅哥，你是来吃饭的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "警察", percent: 10, actions: ["逛逛"], costs: [0], words: ["帅哥，你是来报案的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "澡堂服务员", percent: 20, actions: ["洗澡"], costs: [100], words: ["帅哥，你是来洗澡的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "银行柜员", percent: 20, actions: ["存钱"], costs: [0], words: ["帅哥，你是来存钱的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "教堂修女", percent: 20, actions: ["祈祷"], costs: [100], words: ["先生，你是来祈祷的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "舞台剧场演员", percent: 20, actions: ["看舞台剧"], costs: [300], words: ["帅哥，你是来看舞台剧的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "牙医护士", percent: 20, actions: ["看牙医"], costs: [100], words: ["帅哥，你是来看牙医的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "医院护士", percent: 20, actions: ["看病"], costs: [1000], words: ["帅哥，你是来看病的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "海关总署海关审核员", percent: 20, actions: ["进口一批货物"], costs: [10000], words: ["帅哥，你是来过海关的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "机场空姐", percent: 20, actions: ["买机票"], costs: [10000], words: ["帅哥，你是来买机票的吗？", "帅哥，能加一哈我微信吗？"]},
    {name: "地铁站售票员", percent: 10, actions: ["买地铁票"], costs: [10], words: ["帅哥，你是来买地铁票的吗？", "帅哥，能加一哈我微信吗？"]},
    // {name:"美女",percent:30,actions:["看电影"],words:["帅哥，能跟我换个座吗？","帅哥，能加一哈我微信吗？"]},
    // {name:"美女",percent:30,actions:["看电影"],words:["帅哥，能跟我换个座吗？","帅哥，能加一哈我微信吗？"]},
    // {name:"美女",percent:30,actions:["看电影"],words:["帅哥，能跟我换个座吗？","帅哥，能加一哈我微信吗？"]},
    // {name:"美女",percent:30,actions:["看电影"],words:["帅哥，能跟我换个座吗？","帅哥，能加一哈我微信吗？"]},
    // {name:"美女",percent:30,actions:["看电影"],words:["帅哥，能跟我换个座吗？","帅哥，能加一哈我微信吗？"]},
...
var FRIEND_JOBS = ["球员", "会计", "银行经理", "公司负责人", "青年球员", "球队董事长"];
...
var initializeGame = function () {
    var mainHtml = "";
    mainHtml += "<div class='class-div-buttons' style='position: fixed;top: 0px;z-index: 99999;width:100%;'>" +
        "<button class='class-button-save-game' onclick='classButtonSaveGameClick()'>保存(<span class='class-span-count-down-timer'>" + COUNT_DOWN_TIMER_DEFAULT_VALUE + "</span>)</button>" +
    ...
    //邮件
    mainHtml += "<div class='class-div-content class-div-content-team-mail' style='display:none;margin-top: 43px; border-radius: 12px;'>" +
        ...
        "</div>";
    //所有其他按钮
    mainHtml += "<div class='class-div-content class-div-content-other' style='display:none;margin-top: 43px; border-radius: 12px;'></div>";
...
var getMatch = function (homeIndex, awayIndex, currentTeams) {
    ...
    match.homeScore = -1;
    match.awayScore = -1;
    // match.homeAsiaOdds = -1;
    // match.handicapAsiaOdds = -1;
    // match.awayAsiaOdds = -1;
    // match.betHomeMoney = 0;
    // match.betAwayMoney = 0;
    return match;
}
...
var saveGame = function (showMessage) {
    ...
    setTimeout("saveGameTimeOut()", 100);
    return;
}
...
var saveGameTimeOut = function (showMessage) {
    ...
    if (showMessage == 1) {
        showAlertFrameGame("已保存至本地LocalStorage");
...
var showThisTeam = function (obj, teamId, current) {
    ...
    var mainHtml = "<div " +
        ...
        "style='border:1px solid #FFFFFF;z-index: 9;position:fixed;top:60px;left:" + (offsetMain.left + 10) + "px;width:1206px;background-color:#000000;border-radius:6px;" +
        "' >";
...
var getTeamReference = function (team) {
    ...
    mainHtml += "</td>";
    mainHtml += "</td></tr>";
    mainHtml += "<tr class='class-tr-team-reference-bank-info'><td class='class-td-team-reference-left-info'>约赛历史</td><td>";
...
var getThisPlayerHtml = function (teamPlayer, top, left, isUserPlayer) {
    ...
    var mainHtml = "<div " +
        ...
        "style='border:1px solid #FFFFFF;z-index: 10;position:fixed;top:60px;left:" + (left) + "px;width:666px;background-color:#000000;border-radius:6px;" +
        "' >";
    ...
    if(teamPlayer.girlIndex!=undefined){
        ...
        mainHtml += "<tr>" +
            "<td class='class-td-div-popout-team-player-reference' ><image style='height:126px;' src='image/woman/woman-" +girl.picture+ ".jpg' /></td>" +
            ...
            "<td class='class-td-div-popout-team-player-reference' >" + friendTeamPlayer.happy + "</td>" +
            "</tr>";
        mainHtml += "</table>";
        mainHtml += "</td></tr>";
    }
...
var sendMailToTeam = function (subject, body) {
    ...
    if (userTeam.currentTeams.length - 1 < userTeam.config.teamIndex) {
        ...
        var teamInfo = userTeam.currentTeams[userTeam.config.teamIndex].teamInfo;
        $(".class-td-team-mail").prepend("<div class='class-div-team-mail' unread='1' body=\"" + body + "\" onclick='showThisMail(this)'>" + getCurrentTime() + " " +
            userTeam.config.season + "赛季第" + (teamInfo.games + 1) + "周 " + subject + "</div>");
    }
...
var showMapQuery = function (query) {
    var url = "https://map.sogou.com/#lq=" + query;
    closePopoutReference();
